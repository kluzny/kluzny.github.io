  ...
  return function (moduleArg = {}) {
    ...
    var GodotAudio = {
      ...
      SampleNode: class SampleNode {
            ...
            switch (event.data['type']) {
              case 'position':
                this._playbackPosition =
                  parseInt(event.data.data, 10) / this.getSample().sampleRate + this.offset
                break
              default:
            }
          }
        ...
        _pause() {
          ...
          this.isPaused = true
          this.pauseTime =
            (GodotAudio.ctx.currentTime - this._sourceStartTime) / this.getPlaybackRate()
          this._source.stop()
        }
        _unpause() {
          this._restart()
      ...
      start_sample: function (playbackObjectId, streamObjectId, busIndex, startOptions) {
        ...
        GodotAudio.SampleNode.create(
          { busIndex: busIndex, id: playbackObjectId, streamObjectId: streamObjectId },
          startOptions
        )
      },
      ...
      create: function (
        ...
        if ('connectionState' in conn && conn['connectionState'] !== undefined) {
          ...
          conn.oniceconnectionstatechange = function (event) {
            ...
            onConnectionChange(
              GodotRTCPeerConnection.ConnectionStateCompat[conn.iceConnectionState] || 0
            )
          }
        }
              ...
              function onReferenceSpaceSuccess(reference_space, reference_space_type) {
                ...
                window.setTimeout(function () {
                  ...
                  const enabled_features =
                    'enabledFeatures' in session ? Array.from(session.enabledFeatures) : []
                  ...
                  const environment_blend_mode_c_str =
                    GodotRuntime.allocString(environment_blend_mode)
                  onstarted(
    ...
    function _godot_webxr_update_input_source(
      ...
      if (input_source.hand && r_hand_joints !== 0 && r_hand_radii !== 0) {
        ...
        if (
          frame.fillPoses(input_source.hand.values(), space, hand_joint_array) &&
    ...
    var __Z14godot_web_mainiPPc = (Module['__Z14godot_web_mainiPPc'] = createExportWrapper(
      '_Z14godot_web_mainiPPc',
      2
    ))
    var _main = (Module['_main'] = createExportWrapper('__main_argc_argv', 2))
    var _malloc = createExportWrapper('malloc', 1)
    var _fflush = createExportWrapper('fflush', 1)
    var __emwebxr_on_input_event = (Module['__emwebxr_on_input_event'] = createExportWrapper(
      '_emwebxr_on_input_event',
      2
    ))
    var __emwebxr_on_simple_event = (Module['__emwebxr_on_simple_event'] = createExportWrapper(
